 ...
 * - Imposto Seletivo (IS) representado via cClassTrib = "000003" para os produtos sujeitos (veículos, bebidas alcoólicas, cigarros).
...
const taxRules = [
  ...
  // =============================================
  {
    ...
    icmsRate: "0.0191",
    issRate: "0.0000",
    cClassTrib: "000003", // sujeito ao Imposto Seletivo
    cst: "001",
    status: "ACTIVE",
  },
  {
  ...
  // =============================================
  {
    ...
    cClassTrib: "000002", // classificação para serviços
    cst: "002",
    status: "ACTIVE",
  },
  {
